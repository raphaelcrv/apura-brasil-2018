...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getCandidatesGlobo = function () {
        this.candidateService.getGlobo().then(function (response) {
            console.log(response);
        });
    };
    //   total eleitores [e]
...
var CandidateService = /** @class */ (function () {
    ...
    CandidateService.prototype.getGlobo = function () {
        return this.http.get('http://s.glbimg.com/jo/el/2018/apuracao/1-turno/br/executivo.json').toPromise().then(function (res) { return res.json(); });
    };
